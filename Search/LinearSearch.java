...
// Time Complexity: O(n); Where n is the size of the array. So, It is not very efficient fot large arrays

// Space Complexity: O(1); Uses no extra space to search the element.
